...
function createQuestionTrivia(req, res, next) {
  req.body.id_trivia = parseInt(req.body.id_trivia);
  req.body.id_question = parseInt(req.body.id_question);
  db.none('insert into pregunta_trivia(id_question, id_trivia)' +
